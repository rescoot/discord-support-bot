...
def test_t_formats_with_kwargs():
    msg = t("reload_ok", "de", faq=3, glossary=4, diagnose=2, forum_welcome=1, howto=5, forum_tags=7)
    assert "3" in msg and "4" in msg and "2" in msg and "5" in msg and "7" in msg
